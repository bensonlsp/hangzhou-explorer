...
`vendor/three.module.js`：Three.js，MIT 授權。完整授權及著作權聲明見 `vendor/THREE-LICENSE.txt`，並保留模組內的既有聲明。

## 視覺素材

場景為程式建立的簡化地形、水道、橋樑、民居、展館與植被。沒有使用外部照片、標誌、地圖圖磚、建築模型或掃描資料。地標以通用意象呈現，不表示場館認可。

## 公開文字來源

- 西湖文化景觀：https://whc.unesco.org/en/list/1334/
- 大運河：https://whc.unesco.org/en/list/1443/
- 西溪濕地背景：https://zh.wikipedia.org/wiki/西溪濕地
- 錢塘江背景：https://en.wikipedia.org/wiki/Qiantang_River
- 浙江省博物館：https://www.zjmuseum.com.cn/cn/
